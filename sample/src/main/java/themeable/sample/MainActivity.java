    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blueTheme = Themeable.Theme.newInstance("MyBlueTheme")
                ...
                .addStyle(new StyleBuilder(this, R.style.ButtonFull)
                    .setTextColor(bluePalette.getTextIconsColor())
        ...
        greenTheme = Themeable.Theme.newInstance("MyGreenTheme")
                ...
                .addStyle(new StyleBuilder(this, R.style.ButtonFull)
                    .setTextColor(Color.GREEN)
                        .setTextColor(new int[]{-android.R.attr.state_enabled}, Color.BLACK)
                        .setTextColor(new int[]{android.R.attr.state_pressed}, greenPalette.getPrimaryDarkColor())
                    ...
                    .build())
                .addStyle(new StyleBuilder(this, R.style.ButtonPrimary)
                    .setTextColor(greenPalette.getTextIconsColor())
